...
export function Home() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative z-10 max-w-screen-xl w-full mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-2xl mx-auto">
              Detect scam messages and malicious links using AI
            </p>
          </motion.div>
      ...
      {/* Features Section */}
      <section className="py-24 px-6 bg-gradient-to-b from-transparent to-[#131829]/50">
      ...
      <section className="py-24 px-6">
        <div className="max-w-screen-xl mx-auto">
          ...
          >
            <div>
              <div className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#00d9ff] to-[#00ff41] mb-2">
            ...
            <div>
              ...
              <div className="text-gray-400 text-lg">Users Protected</div>
            </div>
            <div>
              <div className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#00d9ff] to-[#00ff41] mb-2">
      ...
      {/* Footer */}
      <footer className="py-12 px-6 border-t border-[#00d9ff]/20 bg-[#131829]/50">
        <div className="max-w-screen-xl mx-auto">
